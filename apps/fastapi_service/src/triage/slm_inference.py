...
def _build_triage_prompt(alert_dict: dict[str, Any]) -> str:
    ...
    prompt = f"""<|system|>
You are a senior SOC analyst. Your task is to evaluate the following SIEM alert and classify it as TruePositive or FalsePositive.
...
def _run_slm_inference_sync(model_path: str, alert_dict: dict[str, Any]) -> dict[str, Any]:
    ...
    if llm is None:
        ...
        return {"grade": grade, "confidence": 0.95 if grade == "TruePositive" else 0.85}
